...
| Field | Value |
|-------|-------|
| HSK-Superpowers version | |
| Harness (Claude Code, Cursor, etc.) | |
| Harness version | |
| Model | |
| OS + shell | |

## Is this an HSK-Superpowers issue or a platform issue?
<!-- HSK-Superpowers is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without HSK-Superpowers installed.

     If the problem persists without HSK-Superpowers, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without HSK-Superpowers installed
