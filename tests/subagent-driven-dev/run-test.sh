...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/hsk-superpowers
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/hsk-superpowers-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using hsk-superpowers:subagent-driven-development. The plan is at: $PLAN_PATH"
