...
Execute this plan using the `hsk-superpowers:subagent-driven-development` skill.
...
**Do:**
- Initialize `go.mod` with module name `github.com/hsk-superpowers-test/fractals`
