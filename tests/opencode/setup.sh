...
mkdir -p "$HOME/.config/opencode/hsk-superpowers"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/hsk-superpowers/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/hsk-superpowers/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/hsk-superpowers/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/hsk-superpowers.js" "$HOME/.config/opencode/hsk-superpowers/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/hsk-superpowers/.opencode/plugins/hsk-superpowers.js" \
       "$HOME/.config/opencode/plugins/hsk-superpowers.js"
...
echo "Plugin installed to: $HOME/.config/opencode/hsk-superpowers/.opencode/plugins/hsk-superpowers.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/hsk-superpowers.js"
